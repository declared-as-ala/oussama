...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.registerForm = this.fb.group({
      ...
      organizationCode: ['DEMO', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]],
  ...
  onSubmit(): void {
    ...
    const payload: RegisterRequest = {
      ...
      organizationCode: this.registerForm.value.organizationCode.trim().toUpperCase(),
